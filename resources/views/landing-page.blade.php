...
<body class="home">
                ...
                <div class="right-header">
                    <nav class="main-menu">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="#">Mulai Buat Jasa<i class="fa fa-caret-down" aria-hidden="true"></i></a>
                            </li>
                            {{-- <li>
        ...
        <main id="main" class="site-main">
            <div class="sideshow">
                <div class="container">
                    <div class="sideshow-content">
                        <h1 class="wow fadeInUp" data-wow-delay=".2s">Bring new ideas to life, anywhere</h1>
                        <div class="sideshow-description wow fadeInUp" data-wow-delay=".1s">Nullam in dui mauris.
                            Vivamus hendrerit arcu sed erat molestie vehicula. Sed auctor neque eu teus.</div>
            ...
            <div class="popular campaign">
                <div class="container">
                    ...
                    <div class="description">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
                        dolore.</div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-6">
                                <div class="campaign-item">
                                    ...
                                    <div class="campaign-box">
                                        ...
                                        <h3><a href="campaign_detail.html">Poster MockUp Design</a></h3>
                                        <div class="campaign-description">However hard he threw himself onto his right,
                                            he always rolled back to where he was.</div>
                                        <div class="campaign-author"><a class="author-icon" href="#"><img
                                                    src="images/placeholder/35x35.png" alt=""></a>by <a
                                                class="author-name" href="#">Andrew Noah</a></div>
                                        <div class="process">
                                            <div class="raised"><span></span></div>
                                            <div class="process-info">
                                                <div class="process-pledged"><span>$610</span>pledged</div>
                                                <div class="process-funded"><span>73%</span>funded</div>
                                                <div class="process-time"><span>25</span>days ago</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="campaign-item">
                                    ...
                                    <div class="campaign-box">
                                        ...
                                        <h3><a href="campaign_detail.html">Svalbard, an arcticficial life</a></h3>
                                        <div class="campaign-description">One morning, when Gregor Samsa woke from
                                            troubled dreams.</div>
                                        <div class="campaign-author"><a class="author-icon" href="#"><img
                                                    src="images/placeholder/35x35.png" alt=""></a>by <a
                                                class="author-name" href="#">Samino</a></div>
                                        <div class="process">
                                            <div class="raised"><span></span></div>
                                            <div class="process-info">
                                                <div class="process-pledged"><span>$3900</span>pledged</div>
                                                <div class="process-funded"><span>69%</span>funded</div>
                                                <div class="process-time"><span>17</span>days ago</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="campaign-item">
                                    ...
                                    <div class="campaign-box">
                                        <a href="#" class="category">Film &amp; Video</a>
                                        <h3><a href="campaign_detail.html">Interestingly Unique Project</a></h3>
                                        <div class="campaign-description">However hard he threw himself onto his right,
                                            he always rolled back to where he was.</div>
                                        <div class="campaign-author"><a class="author-icon" href="#"><img
                                                    src="images/placeholder/35x35.png" alt=""></a>by <a
                                                class="author-name" href="#">Sabato Alterio</a></div>
                                        <div class="process">
                                            <div class="raised"><span></span></div>
                                            <div class="process-info">
                                                <div class="process-pledged"><span>$1200</span>pledged</div>
                                                <div class="process-funded"><span>110%</span>funded</div>
            ...
            <div class="explore">
                <div class="container">
                    <h2 class="title">Explore Ideas</h2>
                    <div class="description">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
                        dolore.</div>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                <div class="explore-item">
                                    <a class="explore-overlay" href="#">
                                        <img src="images/placeholder/270x180.png" alt="">
            ...
            <div class="staff-picks">
                <div class="container">
                    <div class="border-title">
                        <h2 class="title left-title">Staff Picks</h2>
                        <div class="description left-description">Lorem Ipsum is simply dummy text of the printing and
                    ...
                    <div class="staff-picks-content">
                        <div class="staff-picks-slider slider-controls-top owl-carousel">
                            <div class="staff-picks-item clearfix">
                                <a class="staff-picks-image" href="campaign_detail.html"><img
                                        src="images/placeholder/570x350.png" alt=""></a>
                                <div class="staff-picks-item-content staff-picks-box">
                                    <a href="#" class="category">Design &amp; Art</a>
                                    <h3><a href="campaign_detail.html">Creative Furniture Designs</a></h3>
                                    <div class="staff-picks-description">He lay on his armour-like back, and if he
                                        ...
                                        and seemed ready to slide off any moment.</div>
                                    <div class="staff-picks-author">
                                        <div class="author-profile">
                                            <a class="author-avatar" href="#"><img src="images/placeholder/40x40.png"
                                                    alt=""></a>by <a class="author-name" href="#">Andrew Noah</a>
                                        </div>
                                        <div class="author-address"><span class="ion-location"></span>Melbourne,
                                            Victoria, AU</div>
                                    </div>
                                    <div class="process">
                                        <div class="raised"><span></span></div>
            ...
            <div class="latest campaign">
                <div class="container">
                    <h2 class="title">Latest Campaigns</h2>
                    <div class="description">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
                        dolore.</div>
                    <div class="campaign-content">
                        <div class="row">
                            <div class="col-lg-4 col-sm-6">
                                <div class="campaign-item">
                                    ...
                                    <div class="campaign-box">
                                        ...
                                        <div class="campaign-description">A watch designed to be an heirloom to be
                                            passed down to the next generation.</div>
                                        <div class="campaign-author"><a class="author-icon" href="#"><img
                                                    src="images/placeholder/35x35.png" alt=""></a>by <a
                                                class="author-name" href="#">Sabato Alterio</a></div>
                                        <div class="process">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="campaign-item">
                                    ...
                                    <div class="campaign-box">
                                        ...
                                        <div class="campaign-description">One mdart, reusable notebook to last the rest
                                            of your life? That's not magic, that's the Everlast.</div>
                                        <div class="campaign-author"><a class="author-icon" href="#"><img
                                                    src="images/placeholder/35x35.png" alt=""></a>by <a
                                                class="author-name" href="#">Samino</a></div>
                                        <div class="process">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="campaign-item">
                                    ...
                                    <div class="campaign-box">
                                        ...
                                        <div class="campaign-description">The Orsden Slope Pants don't compromise
                                            delivering performance, fit, and value directly to you</div>
                                        <div class="campaign-author"><a class="author-icon" href="#"><img
                                                    src="images/placeholder/35x35.png" alt=""></a>by <a
                                                class="author-name" href="#">Andrew Noah</a></div>
                                        <div class="process">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="campaign-item">
                                    ...
                                    <div class="campaign-box">
                                        ...
                                        <h3><a href="campaign_detail.html">mdart Wallet with Solar Charge</a></h3>
                                        <div class="campaign-description">A wonderful serenity has taken possession of
                                            my entire soul, like these sweet mornings.</div>
                                        <div class="campaign-author"><a class="author-icon" href="#"><img
                                                    src="images/placeholder/35x35.png" alt=""></a>by <a
                                                class="author-name" href="#">Andrew Noah</a></div>
                                        <div class="process">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="campaign-item">
                                    ...
                                    <div class="campaign-box">
                                        ...
                                        <div class="campaign-description">I enjoy with my whole heart. I am alone, and
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="campaign-item">
                                    ...
                                    <div class="campaign-box">
                                        ...
                                        <div class="campaign-description">Far far away, behind the word mountains, far
                                ...
                                <div class="follow">
                                    ...
                                    <ul>
                                        ...
                                        <li class="instagram"><a target="_Blank"
                                                href="http://www.instagram.com"><i class="fa fa-instagram"
                                                    aria-hidden="true"></i></a></li>
                                        <li class="google"><a target="_Blank" href="http://www.google.com"><i
    ...
    <script src="{{ asset('template/libs/owl-carousel/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('template/libs/jquery.countdown/jquery.countdown.min.js') }}"></script>
    <script src="{{ asset('template/libs/wow/wow.min.js') }}"></script>
    <script src="{{ asset('template/libs/isotope/isotope.pkgd.min.js') }}"></script>
    <script src="{{ asset('template/libs/bxslider/jquery.bxslider.min.js') }}"></script>
    <script src="{{ asset('template/libs/magicsuggest/magicsuggest-min.js') }}"></script>
