        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
            <div class="col">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <small class="text-right">Jasa</small>
            ...
            <div class="col">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <small class="text-right">Jasa</small>
                        <p class="card-text">Pembuatan Website</p>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star"></span>
            ...
            <div class="col">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <small class="text-right">Jasa</small>
                        <p class="card-text">Penyewaan Kendaraan</p>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star"></span>
            ...
            <div class="col">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <small class="text-right">Jasa</small>
                        <p class="card-text">Les Privat</p>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star"></span>
            ...
            <div class="col">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <small class="text-right">Jasa</small>
                        <p class="card-text">Pariwisata</p>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star"></span>
            ...
            <div class="col">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <small class="text-right">Jasa</small>
                        <p class="card-text">Menulis Artikel</p>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star"></span>
            ...
            <div class="col">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <small class="text-right">Jasa</small>
                        <p class="card-text">Perbaikan Kendaraan</p>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star"></span>
